...
//     private readonly ClothingSize size;
...
//     protected Clothing(int id, string name, ClothingSize size, Gender gender, decimal price, int quantity)
//     {
//         this.id = id > 0
//             ? id
